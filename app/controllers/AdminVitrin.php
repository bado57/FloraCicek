        ...
        if ($_POST && $_SERVER["HTTP_X_REQUESTED_WITH"] == "XMLHttpRequest") {
            ...
            Switch ($tip) {
                ...
                case "sabitIcerikEkle":
                    ...
                    $form->post("fax", true);
                    $form->post("iletisimmail", true);
                    $form->post("harita", true);
                    $form->post("facebook", true);
                    $form->post("twitter", true);
                    $form->post("instagram", true);
                    $form->post("googleplus", true);
                    $form->post("adres", true);
                    $form->post("yoneticimail", true);
                    $form->post("yoneticimailek", true);
                    $telefon = $form->values['telefon'];
                    $fax = $form->values['fax'];
                    $iletisimmail = $form->values['iletisimmail'];
                    $harita = $form->values['harita'];
                    $facebook = $form->values['facebook'];
                    $twitter = $form->values['twitter'];
                    $instagram = $form->values['instagram'];
                    $googleplus = $form->values['googleplus'];
                    $adres = $form->values['adres'];
                    $yoneticimail = $form->values['yoneticimail'];
                    $yoneticimailek = $form->values['yoneticimailek'];
                ...
                case "sayfaEkle":
                    ...
                    $form->post("sayfaTuru", true);
                    $form->post("sayfaAdi", true);
                    $form->post("sira", true);
                    $form->post("durum", true);
                    $form->post("ustSayfa", true);
                    $form->post("degisecekID", true);
                    $form->post("sonUstSira", true);
                    $sayfaTuru = $form->values['sayfaTuru'];
                    $sayfaAdi = $form->values['sayfaAdi'];
                    $sira = $form->values['sira'];
