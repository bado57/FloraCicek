...
class BackupMysql extends Controller {
    ...
    public function index() {
        $this->backup("localhost", "root", "", "floracicek");
        //veya 5. paremetre (array) olabilir: array("mytable1","mytable2","mytable3")
    }
