                        ...
                        <input name="kapaliacik" type="hidden" value="0" >
                            <input name="duzenleme" type="hidden" value="" >
                                <input name="duzenlemeID" type="hidden" value="" >
                                    <input name="eskikatval" type="hidden" value="" >
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                <table id="kampanyaTable" class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php for ($kmpnya = 0; $kmpnya < count($model[0]); $kmpnya++) { ?>
                                                            <?php if ($model[0][$kmpnya]['Aktif'] == "0") { ?>
                                                                <tr id="<?php echo $model[0][$kmpnya]['ID']; ?>">
                                                                <?php } else { ?>
                                                                <tr id="<?php echo $model[0][$kmpnya]['ID']; ?>" class="text-green">
                                                                <?php } ?>
                                                                <td><b><?php echo $model[0][$kmpnya]['Baslik']; ?></b></td>
                                                                <td>% <?php echo $model[0][$kmpnya]['Yuzde']; ?></td>
                                                                <?php if ($model[0][$kmpnya]['Aktif'] == "0") { ?>
                                                                    <td id="kampanyaaktif<?php echo $model[0][$kmpnya]['ID']; ?>" data-aktif="<?php echo $model[0][$kmpnya]['Aktif']; ?>">Bitti</td>
                                                                <?php } else { ?>
                                                                    <td id="kampanyaaktif<?php echo $model[0][$kmpnya]['ID']; ?>" data-aktif="<?php echo $model[0][$kmpnya]['Aktif']; ?>">Devam Ediyor</td>
                                                                <?php } ?>
                                                                <td class="text-right">
