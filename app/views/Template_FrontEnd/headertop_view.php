                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div style="display:none;" class="panel-group" id="sipaccordion" role="tablist" aria-multiselectable="true">
                                    <!-- Sipariş Durumu -->
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="btn-group text-center" role="group" style="width:100%;">
                                            <a href="<?php echo SITE_URL ?>/Home/bireysel" role="button" class="btn btn-default col-xs-6"><span class="fa fa-user"></span> <?php echo Session::get("KAdSoyad"); ?></a>
                                            <a id="cikisYap" role="login" class="btn btn-default col-xs-6"><span class="fa fa-sign-out"></span> Çıkış Yap</a>
                                        </div>
                                    </div>
                                </div>
                                <hr/>
