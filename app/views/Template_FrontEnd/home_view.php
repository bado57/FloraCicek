                            ...
                            <?php foreach ($model[4] as $vitrinModel) { ?>
                                <div class="item <?php echo $model[4][0]['ID'] == $vitrinModel['ID'] ? 'active' : ''; ?> col-xs-12">
                                    <div class="col-sm-6 col-xs-6">
                                        <h1><?php echo $vitrinModel['Baslik']; ?></h1>
                                        <h2 class="hidden-xs"><?php echo $vitrinModel['AltBaslik']; ?></h2>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="product-image-wrapper">
                                                    <div class="single-products">
                                                        <div class="productinfo text-center">
                                                            <div class="imgThumb">
                                                                <img src="<?php echo SITE_PRODUCT ?>/<?php echo $model[5][1][$artandeger]['Path']; ?>" alt="Türkiye Flora Çiçek <?php echo $model[5][1][$artandeger]['Adi']; ?>" />
                                                            </div>
