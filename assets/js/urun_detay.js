$(document).ready(function () {
    ...
    $(document).on("click", "button#urunSipVer", function (e) {
        ...
        var semtText = $("#semtSec option:selected").text();
        var mahText = $("#mahalleSec option:selected").text();
        ...
        var semtID = $("#semtSec option:selected").val();
        var mahID = $("#mahalleSec option:selected").val();
        ...
        $.ajax({
            ...
            cache: false,
            dataType: "json",
            data: {"urunID": urunID, "ilText": ilText, "ilceText": ilceText, "semtText": semtText,
                "mahText": mahText, "tarih": tarih, "pKodu": pKodu, "saat": saat,
                "ilID": ilID, "ilceID": ilceID, "semtID": semtID,
                "mahID": mahID, "saatID": saatID, "tip": "urunDetay"},
            success: function (cevap) {
                if (cevap.hata) {
                    reset();
                    alertify.alert(cevap.hata);
